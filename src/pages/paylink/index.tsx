  ...
  const COLUMNS = [
    ...
    },
    {
      ...
      Cell: ({ cell }) => (
        <>
          <div>
            <Link href={'/products/' + cell.row.original.productId}>
              {cell.value}
            </Link>
          </div>
        </>
        ...
        <>
          <div>
            <Link
              ...
              onClick={async (e) => {
                e.preventDefault();
                await axios.delete('/api/paylink/' + value);
                setData(
